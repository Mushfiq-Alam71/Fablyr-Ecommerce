         ...
         {isOpen ? (
            <form
               ...
               <button
                  ...
                  className='absolute right-98 top-1/2 transform -translate-y-1/2 text-gray-600 hover:text-gray-800 transition-colors'
               >
                  <HiMiniXMark
                     className='h-6 w-6' />
               </button>
            ...
            <button
               onClick={handleSearchToggle}>
               <HiMagnifyingGlass
                  className="h-6 w-6 text-gray-700 hover:text-fablyr-red transition-colors" />
            </button>
         )}
      </div>
   )
